...
init_map(datapath= 'https://rawgit.com/AlxClt/French-Wine-Map/master/wine_data.json')

init_data(datapath= 'https://rawgit.com/AlxClt/French-Wine-Map/master/wine_data.json')
